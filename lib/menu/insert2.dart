...
class Insert2 extends StatefulWidget {
  ...
  const Insert2(this.editdata, {super.key});

  @override
  State<Insert2> createState() => _InsertState2();
}

class _InsertState2 extends State<Insert2> {
  ...
  Future<void> fetchData() async{
    String url = "http://192.168.1.60/flutter_project/raijai.php";
